...
Properties
{
	...
	[Header(Debug)]
	[Toggle(DIFFUSE_ONLY)]DiffuseOnly("Diffuse", int) = 0
	[Toggle(SPECULAR_ONLY)]SpecularOnly("Specular", int) = 0
	[Toggle(DISTRIBUTION_ONLY)]DistributionOnly("Distribution", int) = 0
	[Toggle(FRESNEL_ONLY)]FresnelOnly("Fresnel", int) = 0
	[Toggle(GEOMETRY_ONLY)]GeometryOnly("Geometry", int) = 0
}
...
#pragma shader_feature DIFFUSE_ONLY
#pragma shader_feature SPECULAR_ONLY
#pragma shader_feature DISTRIBUTION_ONLY
#pragma shader_feature FRESNEL_ONLY
#pragma shader_feature GEOMETRY_ONLY


#if DIFFUSE_ONLY || DIFFUSE_ONLY || DISTRIBUTION_ONLY || FRESNEL_ONLY || GEOMETRY_ONLY
#define PBR_DEBUG 1
#else 
#define PBR_DEBUG 0
#endif
